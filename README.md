...
## 🧪 Technical Labs & Logic Practice
*Mini-projects focused on specific JavaScript logic and styling techniques.*

- **[Productivity Scheduler](https://github.com/Sanskar-Joshi/productivity-scheduler):** A time-blocking tool for task management.
- **[Neon Logic Game](https://github.com/Sanskar-Joshi/neon-logic-game):** A Tic-Tac-Toe implementation focusing on DOM state management and neon-themed CSS.

### 📈 Current Focus
- 🏗️ Building a robust **Real Estate Platform**.
- 🧠 Deepening my knowledge of **JavaScript Logic & Algorithms**.
- 🎨 Refining **Responsive Web Design** techniques.
